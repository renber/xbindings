...
public final class JTableBinding<E, SS, TS> extends AutoBinding<SS, List<E>, TS, List> {
     ...
     */
    protected JTableBinding (final  UpdateStrategy strategy,
                             final  SS sourceObject,
                             final  Property<SS, List<E>> sourceListProperty,
                             final  TS targetObject,
                             final  Property<TS, ? extends JTable> targetJTableProperty,
                             final  String name) {
    ...
    public final class ColumnBinding extends AbstractColumnBinding {
         ...
         *
         **************************************************************************************************************/
        public  ColumnBinding setRenderer ( TableCellRenderer renderer) {
         ...
         *
         **************************************************************************************************************/
        public  ColumnBinding setEditor ( TableCellEditor editor) {
            this.editor = editor;
            return this;
        }
