 ...
 */
/*
 * Binding<...> now implements XBinding, so that there is a light-weight common interface for binding objects 
 * @author berre
 *
 */
public abstract class Binding<SS, SV, TS, TV> implements XBinding {
    private String name;
     ...
     */
    protected Binding (final  SS sourceObject,
                       final  Property<SS, SV> sourceProperty,
                       final  TS targetObject,
                       final  Property<TS, TV> targetProperty,
                       final  String name) {
