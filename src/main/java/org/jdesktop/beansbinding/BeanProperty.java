...
import org.jdesktop.xbindings.properties.XReadOnlyPropertyAdapterProvider;
...
public final class BeanProperty<S, V> extends PropertyHelper<S, V> {
     ...
     *         no property names
     */
    public static final <S, V> BeanProperty<S, V> create(
        Property<S, ?> baseProperty, String path) {
    ...
    public Class<?extends V> getWriteType(S source) {
        ...
        if (entry != null) {
            ...
            return (Class<?extends V>) getType(entry.cache[path.length() - 1],
                path.getLast());
        }
    ...
    public V getValue(S source) {
        ...
        if (src == NOREAD) {
            ...
            throw new UnsupportedOperationException("Unreadable (Path: " + path.toString() + " on " + source.getClass().getName() + ")");
        }
    ...
    public void setValue(S source, V value) {
        ...
        if (entry != null) {
            ...
            try {
                ...
                write(entry.cachedWriter, entry.cache[path.length() - 1],
                    path.getLast(), value);
            } finally {
    ...
    /*
     * Returns the property path this BeanProperty is bound to
     */
    ...
    private void registerListener(Object object, String property,
        SourceEntry entry) {
        assert object != null;
     ...
     * @throws PropertyResolutionException
     */
    private void unregisterListener(Object object, String property,
        SourceEntry entry) {
        if ((object != null) && (object != NOREAD)) {
            if (object instanceof ObservableMap) {
    ...
    private final class SourceEntry implements PropertyChangeListener,
        ...
        private void updateCachedValue() {
            ...
            if ((src == null) || (src == NOREAD)) {
                ...
                cachedValue = getProperty(cache[path.length() - 1],
                        path.getLast());
